...
/* ========================================================================================
 *
 * Return the ACF Field 'Custom LEFT Background Colour' HEX Value for Series.
 *
 * Used to retrieve the left panel colour (or CSS Override code) for a specific series.
 *
 * Location: Series > Series Post > Header Slider
 *
 * [series_background_left_panel_colour]
 *
 ...
 *
 * ======================================================================================= */
function shortcode_series_background_left_panel_colour($attr = null){


    $args = shortcode_atts( array(
        'id'    => get_the_id(),
        'membership_id' => null,
        'class' => '.mvdb-series-left-panel',
        'return' => 'style'
    ), $attr );
    ...
    $background_hex = get_field('series_background_left_panel_colour', $args['id']);
    $background_css = get_field('series_background_left_panel_css_override', $args['id']);
...
add_filter( 'init',function(){
    add_shortcode( 'series_background_left_panel_colour', 'shortcode_series_background_left_panel_colour' );
});
...
register_custom_shortcode_docs(
    array(
        'category'      => 'series',
        'slug'          => 'series_background_left_panel_colour',
        'code'          => '[series_background_left_panel_colour]',
        'description'   => 'Returns a style with a CSS selector set to the colour of the ACF background left panel.',
        'inputs'        => '<ul><li>id @string</li>
                                <li>membership_id @string</li>
                                <li>class @string</li>
                                </ul>',
        'outputs'       => '@string Return the colour of specified ACF colour',
        'example'       => '[series_background_left_panel_colour]',
    )
);

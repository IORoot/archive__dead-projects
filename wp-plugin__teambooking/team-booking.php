...
/**
 * Plugin Name: _ANDYP - Team Booking
 * Plugin URI: http://stroheimdesign.com
 * Description: <strong>🔌PLUGIN</strong> | <em>TeamBooking 2.5.7</em> | Booking system for reservations and appointments
 * Version: 2.5.7
 * Author: VonStroheim (ANDY P Changes)

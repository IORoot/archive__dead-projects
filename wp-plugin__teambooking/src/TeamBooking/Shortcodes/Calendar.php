            ...
            <div class="ui calendar_main_container" id="tbk-container-<?= $unique_id ?>" aria-live="polite"
                ...
                if (isset($_GET['tbk_date'])
                    ...
                    if (!$skip) {
                        ...
                        // ANDYP Addition for new query parameter
                        $tbk_service = $parameters->getRequestedServiceIds();
                        if (isset($_GET['tbk_service'])){
                            $tbk_service = array($_GET['tbk_service']); 
                        }
                        ...
                        // ANDYP Change
                        $slots = $calendar->getSlots($tbk_service, $parameters->getRequestedCoworkerIds(), NULL, NULL, FALSE, $parameters->getTimezone());
